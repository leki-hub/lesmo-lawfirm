        ...
        r = (function () {
          ...
          return (
            ...
            (r.prototype._keydown = function (a) {
              ...
              for (c in this._options.keyBinds)
                if (
                  ...
                  ((e = c.split(" ")),
                  e.length === g.length && m[i] === e[e.length - 1])
                ) {
            ...
            (r.prototype._keyup = function (a) {
              (o[a.which] = "r"),
                p[a.which] &&
                  ((p[a.which] = !1), a.stopPropagation(), a.preventDefault());
            }),
          ...
          (k.prototype._getToolbar = function () {
            ...
            if (
              ...
              "times" === this._options.viewMode
                ? ((b = this._options.tooltips.selectDate),
                  (c = this._options.icons.date))
                : ((b = this._options.tooltips.selectTime),
                  (c = this._options.icons.time)),
                a.push(
                  e("<td>").append(
                    e("<a>")
                      .attr({
          ...
          (k.prototype._doAction = function (a, b) {
            ...
            switch ((b = b || e(a.currentTarget).data("action"))) {
              ...
              case "decrementMinutes":
                ...
                this._isValid(r, "m") &&
                  this._setValue(r, this._getLastPickedDateIndex());
                break;
              case "decrementSeconds":
                var s = c.clone().subtract(1, "s");
                this._isValid(s, "s") &&
                  this._setValue(s, this._getLastPickedDateIndex());
                break;
              case "togglePeriod":
                this._setValue(
              ...
              case "togglePicker":
                var t = e(a.target),
                  ...
                  z = void 0;
                if (w && w.length) {
                  if (((z = w.data("collapse")), z && z.transitioning))
                    return !0;
                  w.collapse
              ...
              case "today":
                ...
                this._isValid(B, "d") &&
                  this._setValue(B, this._getLastPickedDateIndex());
            }
            return !1;
          }),
      ...
      e(document)
        ...
        .on(f.Event.FOCUS, "." + f.ClassName.INPUT, function (a) {
          ...
          0 !== b.length &&
            ...
            l._jQueryInterface.call(b, "show", a);
        }),
